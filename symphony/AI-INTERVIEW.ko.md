...
> 흐름은 항상 같으며, 평가는 강제 레벨과 0단계 조사 필요 여부만 정합니다.

---

## 🎯 미션

목적은 **프로젝트 컨텍스트를 평가**해 SDD를 설정하는 것입니다. 두 가지를 정합니다:
...
컨텍스트 신호를 읽고 두 가지를 설정합니다: 강제 레벨과 0단계 조사 실행 여부. SDD 흐름 자체는 모든 경우에 동일합니다.
...
> **이 평가는 5-10분으로 프로젝트 컨텍스트를 읽어 강제 레벨(standard/strict)을 정하고 게이트를 설치합니다. 이후 AI-EXECUTION.ko.md가 하나의 SDD 흐름을 자율 진행합니다 — 어디서든 적용.**
